                                        ...
                                        <div>
                                            <label class="inline-flex items-center">
                                                <input type="checkbox" name="permissions[]" value="{{ $perm->id }}"
                                                    class="w-4 h-4 mr-2" {{ in_array($perm->id, $rolePermissions) ? 'checked' : '' }}>
                                            ...
                                            @foreach($menuItem->children as $child)
                                                ...
                                                <div class="ml-6 mt-1">
                                                    <label class="inline-flex items-center">
                                                        <input type="checkbox" name="permissions[]" value="{{ $childPerm->id }}"
                                                            class="w-4 h-4 mr-2" {{ in_array($childPerm->id, $rolePermissions) ? 'checked' : '' }}>
