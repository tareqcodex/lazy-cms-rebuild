<script>
    ...
    createApp({
        setup() {
            ...
            const searchNavigatorQuery = ref('');
            ...
            const clearEditingContext = () => {
                ...
                activePanelTab.value = 'general';
                searchNavigatorQuery.value = '';
                hoveringElement.value = null;
            };
            ...
            return {
                ...
                searchElementQuery,
                searchNavigatorQuery,
                filteredColumnLayouts, filteredNestedColumnLayouts, filteredAvailableElements,
                shouldShowGuide,
                toasts, showToast,
